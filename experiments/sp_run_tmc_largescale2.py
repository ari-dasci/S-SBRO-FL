...
# Set Parameters
dataset_name = 'svhn'  # Options: 'emnist', 'cifar', 'fashionmnist', 'svhn'
price_test = False
save_dir = f"../result/supplementary_tmc_largescale_final_test_{dataset_name}/"
...
def train_n_rounds(n_rounds, clients_per_round):
    ...
    for i in range(n_rounds):
        ...
        shapley_values = calculate_tmc_shapley(SBRO_selected_clients, acc_history_SBRO_list[-1], val_dataset, device,mc_iterations=10)
