...
from flex.pool import select_nodes_linear_nofilter
...
# SAVE_DIR_BASE = f"../result/supplementary_linear_no_filter_{DATASET_NAME}/"
...
train_n_rounds(exparam.n_rounds, clients_per_round=select_nodes_linear_nofilter, initial_model_path=INITIAL_MODEL_PATH)
