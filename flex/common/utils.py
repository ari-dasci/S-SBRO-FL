...
def save_flex_model(directory, model_name, flex_model):
    """
    Save FlexModel to a file using pickle.
    ...
    with open(file_path, 'wb') as file:
        pickle.dump(flex_model, file)

    print(f"Model saved to {file_path}")


def load_flex_model(file_path):
    """
    Load FlexModel from a file using pickle.
    ...
    --------
    FlexModel
        The loaded FlexModel object.
    """
    with open(file_path, 'rb') as file:
        flex_model = pickle.load(file)
    return flex_model